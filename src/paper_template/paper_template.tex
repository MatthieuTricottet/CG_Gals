...
The sSFR status for each sample is shown in table \ref{tab:sSFR_status}. The probability for \<<sSFR_status[2]>>{} proportion 
...
<<pval_Control4B_Elliptical_vs_CG_pc>> for ellipticals and <<pval_Control4B_Spiral_vs_CG_pc>> for spirals versus \CB{} sample, 
 ...
 and <<pval_RG4_Spiral_vs_CG_pc>>  versus \RG.
\begin{table}
    \centering
    \begin{tabular}{lccc}
        \toprule
