...
\begin{table}
    ...
    \begin{tabular}{lccc}
        \toprule
            ...
            \CB &  32  (0.8 \%) &  1401  (36.3 \%) &  2426  (62.9 \%) \\
            \CC &  31  (0.7 \%) &  1839  (39.1 \%) &  2839  (60.3 \%) \\
            \RG &  0  (0.0 \%) &  149  (55.6 \%) &  119  (44.4 \%)\\
            \emph{SDSS selection} &  \emph{634 (1.2 \%)} &  \emph{44199  (84.1 \%)} &  \emph{7698  (14.7 \%)}\\
         \midrule
        \bottomrule
    \end{tabular}
...
$1.6 \times 10^{-5}$ for ellipticals and $6.0 \times 10^{-1}$ for spirals versus \CB{} sample, 
 ...
 and $2.4 \times 10^{-2}$  versus \RG. Figure \ref{fig:galaxies_morph_sfr} displays the sSFR against masses for galaxies from the SDSS selection and for \CG{}s galaxies.
...
Starforming \CG{} are composed of 85 of their galaxies classified as spiral 
($42.7$\% once galaxies having uncertain morphology removed) and 
114 ($57.3$\% once galaxies having uncertain morphology removed) elliptical.
These figures are 606 ($43.4$\%) spiral
and 790 ($56.6$\%) elliptical galaxies for \CB{}, 
775 ($40.4$\%) spiral
and 1143 ($59.6$\%) elliptical galaxies for \CC{}
and 32 ($53.3$\%) spiral
and 28 ($46.7$\%) elliptical galaxies for \RG{}. 
The probability that those fractions come from 
the same distribution is estimated from the Barnard two-sided exact test as $0.86$ against \CB,
$0.53$ against \CC{} and $0.15$ against \RG. There is thus no significant excess of 
