...
We model the star-forming main sequence as a power law in stellar mass, to various orders (1 to 4) - cf figure . 
We then compute the residuals of each star-forming galaxy to the main sequence,and plot their histograms in figure .
...
$\Delta = 0.057$
($0.028 \le \Delta \le 0.099$, bootstrap),
corresponding to a $p$-value of $p = 0.056$.
...
corresponding to a $p$-value of $p = 0.533$.
