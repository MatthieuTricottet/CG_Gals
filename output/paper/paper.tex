...
% The sSFR status for each sample is shown in table \ref{tab:sSFR_status}. The probability for \Starforming {} proportion to be different form the control sample's 
% one is, estimated using Fisher exact test, is    for the \CGto{} sample, 
%    for \CGtf,    for \CGfo{} and    for \CGff.
