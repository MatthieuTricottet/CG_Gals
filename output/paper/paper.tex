    ...
    \begin{tabular}{llccc}
        \toprule
            ...
            \CG & &  18  (7.3 \%) &  146  (58.9 \%)&  84  (33.9 \%) \\
             & \emph{BGG} &  \emph{  ( \%)} &  \emph{  ( \%)} &  \emph{  ( \%)} \\
             & \emph{Satellites} &  \emph{  ( \%)} &  \emph{  ( \%)} &  \emph{  ( \%)} \\
            ...
            & \emph{Satellites} &  \emph{  ( \%)} &  \emph{  ( \%)} &  \emph{  ( \%)}\\
         \midrule
            \emph{SDSS selection} & &  \emph{634 (1.2 \%)} &  \emph{7698  (14.7 \%)} &  \emph{44199  (84.1 \%)}\\
         \midrule
        \bottomrule
    \end{tabular}
...
$5.7 \times 10^{-5}$ for ellipticals and $8.5 \times 10^{-1}$ for spirals versus \CB{} sample, 
 $2.0 \times 10^{-1}$  and $1.1 \times 10^{-1}$  versus \CC{} and  $1.1 \times 10^{-3}$  
 and $3.2 \times 10^{-3}$  versus \RG. Morphologies of \CG, wich we identified as cores of richer groups in 
...
\begin{table*}
    ...
    \begin{tabular}{lccc}
        \toprule
            ...
            \CG &  52  (21.0 \%) &  53  (21.4 \%)&  143  (57.7 \%) \\
            \CB &  289  (10.3 \%) &  583  (20.9 \%) &  1924  (68.8 \%) \\
            \CC &  533  (17.7 \%) &  781  (26.0 \%) &  1694  (56.3 \%) \\
            \RG &  17  (7.6 \%) &  75  (33.5 \%) &  132  (58.9 \%)\\
...
Starforming \CG{} are composed of 45 of their galaxies classified as spiral 
($84.9$\% once galaxies having uncertain morphology removed) and 
8 ($15.1$\% once galaxies having uncertain morphology removed) elliptical.
These figures are 528 ($90.4$\%) spiral
and 56 ($9.59$\%) elliptical galaxies for \CB{}, 
671 ($85.9$\%) spiral
and 110 ($14.1$\%) elliptical galaxies for \CC{}
and 68 ($95.8$\%) spiral
and 3 ($4.23$\%) elliptical galaxies for \RG{}. 
The probability that those fractions come from 
the same distribution is estimated from the Barnard two-sided exact test as $0.22$ against \CB,
$0.85$ against \CC{} and $4.35 \times 10^{-2}$ against \RG. There is thus 
neither significant excess nor lack of 
starforming elliptical galaxies in \CG{} compared to all our control samples.

If we restrict the comparison to BGGs only, we find 6 Elliptical BGGs (9.7\% of the BGGs) and
2 Spiral BGGs (3.2\%) 
 in \CG{}.
  This is to be compared to 
 71 (10.2\%) Elliptical and
 26 (3.7\%) Spiral galaxies in \CB{}, 
 75 (10.0\%) Elliptical and
 30 (4.0\%)  Spiral in \CC{},
  and  4 (7.1\%) Elliptical and
  6 (10.7\%) Quenched
  in \RG{}. 
